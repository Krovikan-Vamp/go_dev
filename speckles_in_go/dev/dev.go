...
func (m Model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		case "right":
			m.SelectedRows = append(m.SelectedRows, m.Table.SelectedRow())
		case "q", "ctrl+c":
			return m, tea.Quit
		case "enter":
			return m, tea.Batch(
				// tea.Printf("Let's go to %s!", m.Table.SelectedRow()[1]),
				tea.Printf("Let's go to %s!", m.SelectedRows),
			)
		}
	}
...
func HelpMe() (int, error) {
	fmt.Println("help me")
	return 0, nil
}
func (mod Model) Start() {
